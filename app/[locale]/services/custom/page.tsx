...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    ...
    title: `${t.services.custom.title} | Codeprops`,
        ...
        <div className="max-w-4xl">
          ...
          <div className="prose prose-xl prose-invert max-w-none mb-24">
            <p className="text-2xl text-primary font-medium mb-12 leading-relaxed">
              Bespoke software engineering for complex enterprise logic and business automation.
            </p>
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              {t.services.custom.description}
            </p>
            <h2 className="text-3xl font-heading font-bold mt-16 mb-8 text-foreground">Strategic Digital Solutions</h2>
            <p className="text-muted-foreground">
              We specialize in custom software solutions that bridge the gap between legacy systems and modern innovation, ensuring long-term scalability and technical authority.
            </p>
          </div>
        </div>
