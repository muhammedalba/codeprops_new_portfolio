  ...
  return (
    ...
    >
      <Section icon={Sparkles} title={translations.subject}>
        <MotionInput placeholder='your subject' {...form.register("subject")} className="h-16 rounded-2xl" />
         <FormError error={form.formState.errors.subject} />
      </Section>

      <Section icon={Layers} title={translations.message}>
        <MotionTextarea {...form.register("message")} className="min-h-[200px]" placeholder='your message' />
