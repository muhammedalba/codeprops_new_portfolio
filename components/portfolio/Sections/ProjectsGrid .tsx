...
const ProjectCard = React.memo(
  ({ project, index, locale, translations }: { project: Project; index: number; locale: string; translations: Translations }) => {
          ...
          >
            ...
            <div className="absolute inset-12 rounded-[2.5rem] bg-background/40 backdrop-blur-md border border-white/10 shadow-inner flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <div className="text-sm font-mono font-bold tracking-[0.4em] opacity-40 uppercase">
