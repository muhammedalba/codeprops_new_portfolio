...
const SpriteIcon = ({ id, size = 24, ...props }: IconProps & { id: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Icons = {
  twitter: (props: IconProps) => (
    <SpriteIcon id="twitter" {...props} />
  ),
  github: (props: IconProps) => (
    <SpriteIcon id="github" {...props} />
  ),
  linkedin: (props: IconProps) => (
    <SpriteIcon id="linkedin" {...props} />
  ),
  facebook: (props: IconProps) => (
    <SpriteIcon id="facebook" {...props} />
  ),
  ...
  globe: (props: IconProps) => (
    <SpriteIcon id="globe" {...props} />
  ),
  code: (props: IconProps) => (
    <SpriteIcon id="code" {...props} />
  ),
  ...
  plus: (props: IconProps) => (
    <SpriteIcon id="plus" {...props} />
  ),
};

export const IconsSpriteSheet = () => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
    <symbol id="icon-twitter" viewBox="0 0 24 24"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" /></symbol>
